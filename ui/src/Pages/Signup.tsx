...
const Signup = () => {
    ...
    const callSignup = (username: string, email: string, password: string) => {
        setIsLoading(true)
    ...
    return (
        <section className="signup_page">
            <div className="flex">
                <img src="/images/login-screen.jpg" alt="" className="h-screen object-cover w-7/12" />
                <div className="right-side p-6 w-5/12">
                    ...
                    >
                        ...
                        <SwiperSlide><LoginForm /></SwiperSlide>
                    </Swiper>
